<?php 
  /* 
    Template Name: Free Illustrations Page Template
  */
  get_header();
?>
  <div class="main">
          ...
          <ul>
           ...
           // $terms = get_terms([    'taxonomy' => $taxonomy_name,    'hide_empty' => false,]);
              ...
              foreach($categories as $category){
        		...
        		?>	 
              <li><a href="<?php echo get_category_link( $term_id ); ?>"><?php echo $category->name; ?></a></li>
		        <?php } ?>
          </ul>
        </div>
    ...
    <section class="specialsection">
      <div class="container">
        <?php echo do_shortcode('[faqs terms="free-illustrations"]');?>
      </div>
    </section>
  </div>
<?php get_footer();?>